package ro.ubb.cristian.examproject.section2;
...
import ro.ubb.cristian.examproject.section2.subSection2_1.ItemListFragment;
...
//        });
    ...
    private void switchScreen(int id) {
        ...
        if (id == R.id.nav_item_list) {
            ...
            fragment = new ro.ubb.cristian.examproject.section2.subSection2_2.ItemListFragment();
