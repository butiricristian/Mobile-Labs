...
public class EmployeeCarAdapter extends RecyclerView.Adapter<EmployeeCarAdapter.CarViewHolder> {

    private Context mCtx;
    private List<Car> cars;
    private CarController carController;

    public EmployeeCarAdapter(Context mCtx, List<Car> cars, CarController carController) {
        this.mCtx = mCtx;
        this.cars = cars;
