package ro.ubb.cristian.examproject.section1;
...
import ro.ubb.cristian.examproject.section1.subSection1_1.ItemListFragment;
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.section_one, menu);
        return true;
    }
    ...
    private void switchScreen(int id) {
        ...
        if (id == R.id.nav_item_list) {
            ...
            fragment = new ro.ubb.cristian.examproject.section1.subSection1_2.ItemListFragment();
